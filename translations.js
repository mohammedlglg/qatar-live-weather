...
const T = {
    en: {
        ...
        fetching:    "Fetching from wttr.in...",
        ...
        card3Body:   "wttr.in fetches one location at a time. Large regions load progressively.",
        current:     "CURRENT",
        todayMax:    "TODAY MAX",
        todayMin:    "TODAY MIN",
    ...
    ar: {
        ...
        fetching:    "جارٍ جلب البيانات من wttr.in...",
        failed:      "فشل في جلب البيانات. قد يكون wttr.in محدود الطلبات — حاول مجدداً.",
        ...
        card3Body:   "يجلب wttr.in موقعاً واحداً في كل مرة. المناطق الكبيرة تُحمَّل تدريجياً.",
        current:     "الآن",
        todayMax:    "أعلى اليوم",
        todayMin:    "أدنى اليوم",
